...
// Helper: Get ward data from localStorage
export const getWardDataFromLocalStorage = () => {
  try {
...
// Helper: Get bed facilities from localStorage
export const getBedFacilitiesFromLocalStorage = () => {
  try {
    const savedData = localStorage.getItem("bedMasterData");
    if (savedData) {
      const bedMasterData = JSON.parse(savedData);
