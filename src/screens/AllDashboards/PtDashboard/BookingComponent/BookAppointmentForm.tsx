...
const BookAppointmentForm: React.FC<BookAppointmentFormProps> = ({
  ...
  return (
    <View style={styles.outerContainer}>
      ...
      {/* Card Container - Added rounded background */}
      <View  >
        <AvTextInput
        ...
        {error && <AvText style={{ color: "red" }}>{error}</AvText>}

        {/* State Selector - Only bottom border */}
        <AvSelect
          label="Select State"
          items={INDIAN_STATES}
          selectedValue={state}
        ...
        {/* City Selector - Only bottom border */}
        <AvSelect
          label="Select City"
        ...
        {/* Hospital Selector - Only bottom border */}
        <AvSelect
              ...
              renderItem={({ item: specialty }) => (
                <TouchableOpacity
                  style={[
                    ...
                    selectedSpecialty === specialty && styles.selectedSpecialtySliderChip,
                  ]}
          ...
          <FlatList
            ...
            renderItem={({ item: panel }) => (
              <TouchableOpacity
                style={[
                  styles.specialtySliderChip,
                  doctorPanel === panel.value && styles.selectedSpecialtySliderChip,
                ]}
